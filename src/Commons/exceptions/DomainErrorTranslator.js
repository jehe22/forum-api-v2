...
DomainErrorTranslator._directories = {
  ...
  'ADDED_THREAD.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat mengembalikan thread baru karena properti yang dibutuhkan tidak ada'),
  'ADDED_THREAD.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat mengembalikan thread baru karena properti yang dibutuhkan tidak sesuai'),
  ...
  'ADDED_COMMENT.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat mengembalikan comment baru karena properti yang dibutuhkan tidak ada'),
  'ADDED_COMMENT.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat mengembalikan comment baru karena properti yang dibutuhkan tidak sesuai'),
  ...
  'ADDED_REPLY.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat mengembalikan reply baru karena properti yang dibutuhkan tidak ada'),
  'ADDED_REPLY.NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('tidak dapat mengembalikan reply baru karena properti yang dibutuhkan tidak sesuai'),
  ...
  'ADD_THREAD_USE_CASE.NOT_CONTAIN_AUTHENTICATION_HEADER': new AuthenticationError('Missing authentication'),
